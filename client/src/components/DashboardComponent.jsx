...
export default function DashboardComponent() {
  ...
  const [lastMonthMotivations, setLastMonthMotivations] = useState(0);
  ...
  console.log(lastMonthMotivations);
    ...
    const fetchMotivations = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setTotalMotivations(data.totalMotivations);
          setLastMonthMotivations(data.lastMonthMotivations);
        }
      } catch (error) {
        console.log(error.message);
      }
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-60 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              ...
              <p className="text-2xl">{totalMotivations}</p>
            </div>
            <HiDocumentText className="bg-lime-600 text-white rounded-full text-5xl p-3 shadow-lg" />
          </div>
          <div className="flex gap-2 text-sm">
            ...
            posts.map((post) => (
              <Table.Body key={post._id} className="divide-y">
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell className="w-3/5">{post.posttitle}</Table.Cell>
